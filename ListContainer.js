...
const ActivityIndicator = Platform.OS === 'ios' ? ActivityIndicatorIOS : ProgressBarAndroid;
...
class ListContainer extends React.Component {
    ...
    render() {
        ...
        <View style={styles.headerWrapper}>
          <ParallaxBackground
            ...
            maxHeight={EMPTY_CELL_HEIGHT + this.state.stickyHeaderHeight + BuddyHeader.height}
    ...
    renderProfileImage() {
        ...
        return (
            ...
            <Thumbnail size={Dimensions.get('window').width/3} source={this.props.profileImage}/>
        );
    }
