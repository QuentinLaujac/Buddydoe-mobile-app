...
var widthText = 0;
export default class CategoryButtonItem extends Component {
    ...
    return (
      ...
      >
        <TouchableOpacity style={{flex:1}} activeOpacity={this.props.activeOpacity || 0.85} onPress={this.props.onPress}>
          ...
          >
            <Icon name={this.props.iconName} style={{color:'white', fontSize:width/12, marginTop:-3}} />
...
CategoryButtonItem.defaultProps = {
  onPress: () => {},
};
