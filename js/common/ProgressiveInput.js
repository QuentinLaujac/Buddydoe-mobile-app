...
class ProgressiveInput extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    let value = nextProps.value === undefined || nextProps.value === null?this.state.value:nextProps.value;
    let isLoading = nextProps.isLoading === undefined || nextProps.isLoading === null?this.state.isLoading:nextProps.isLoading;
    this.setState({ value: value, isLoading: isLoading});
  }
  ...
  _renderActivityIndicator() {
    let size = this.state.isLoading ? {} : { width: 0, height: 0 };
    return (
      <ActivityIndicator
